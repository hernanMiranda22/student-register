...
class GradeStudentRepository @Inject constructor() {
    ...
    //Logica para ingresar los trimestres del alumno (GradeFragment)
     suspend fun insertGrade(dni:Int, firstTerm:Int,secondTerm:Int,thirdTerm:Int, uid : String): ResourceMenu<TermData> {
        ...
        return ResourceMenu.Success(TermData(firstTerm =  firstTerm, secondTerm = secondTerm, thirdTerm = thirdTerm))
    }
